...
![Количество](./images/description.png)
...
### ID16. Неявный баг. Наличие фильтра "Пешком до метро"
**Шаги воспроизведения**  
1. Откройте страницу поиска.

*Фактический результат:* Отображается фильтр "Пешком до метро".
![Количество](./images/metro.png)

*Ожидаемый результат:* На проде такого фильтра нет(+ не совсем логично искать загородный дом рядом с метро).
